...
%     caxis(c4)
%     set(gca,'ydir','normal');
%     xlabel(['{\bf (a)} $\pi_1$'],'FontSize',16,'interpreter','latex')
...
%     caxis(c4)
%     set(gca,'ydir','normal');
%     xlabel(['{\bf (b)} $\pi_2$'],'FontSize',16,'interpreter','latex')
%   %  ylabel('$y$','FontSize',16,'interpreter','latex')
%     xticks([1:2:20])
%     xticklabels({'1','2','3','4','5'})
%     yticks([1:2:20])
...
%     caxis(c4)
%     set(gca,'ydir','normal');
%     xlabel(['{\bf (c)} $\pi_3$'],'FontSize',16,'interpreter','latex')
%   %  ylabel('$y$','FontSize',16,'interpreter','latex')
%     xticks([1:2:20])
%     xticklabels({'1','2','3','4','5'})
%     yticks([1:2:20])
...
%     caxis(c4)
%     set(gca,'ydir','normal');
%     xlabel(['{\bf (f)} $\pi_7$'],'FontSize',16,'interpreter','latex')
%   %  ylabel('$y$','FontSize',16,'interpreter','latex')
%     xticks([1:2:20])
%     xticklabels({'1','2','3','4','5'})
%     yticks([1:2:20])
...
%     caxis(c4)
%     set(gca,'ydir','normal');
%     xlabel(['{\bf (g)} $\pi_7$'],'FontSize',16,'interpreter','latex')
%   %  ylabel('$y$','FontSize',16,'interpreter','latex')
%     xticks([1:2:20])
%     xticklabels({'1','2','3','4','5'})
%     yticks([1:2:20])
...
%     caxis(c4)
%     set(gca,'ydir','normal');
%     xlabel(['{\bf (h)} $\pi_8$'],'FontSize',16,'interpreter','latex')
%   %  ylabel('$y$','FontSize',16,'interpreter','latex')
%     xticks([1:2:20])
%     xticklabels({'1','2','3','4','5'})
%     yticks([1:2:20])
...
% 
% 
%   pos4=get(posfig{4}, 'Position');
%   pos8=get(posfig{8}, 'Position');
%   colormap jet
% h=colorbar;
% 
% set(h, 'Position', [pos8(1)+pos8(3)+0.01 pos8(2)+0.04 pos8(3)*0.1 pos4(4)+pos4(4)+0.08])
