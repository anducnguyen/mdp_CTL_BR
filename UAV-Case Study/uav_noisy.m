...
posfig{11}=subplot(3,5,11)
for kk=1:n
    x=Statenum(kk,1)*2-1;
    y=Statenum(kk,2)*2-1;
    xx=[x-ds/2 x+ds/2];
    yy=[y-ds/2 y+ds/2];
    imagesc(xx,yy,pv(kk,12))
    hold on
end
axis([0 10 0 10])
colorbar
caxis(c4)
set(gca,'ydir','normal');
xlabel(['{\bf (g)} $\pi_{11}$'],'FontSize',16,'interpreter','latex')
xticks([1:2:20])
xticklabels({'1','2','3','4','5'})
yticks([1:2:20])
yticklabels({'1','2','3','4','5'})
...
posfig{12}=subplot(3,5,12)
for kk=1:n
    x=Statenum(kk,1)*2-1;
    y=Statenum(kk,2)*2-1;
    xx=[x-ds/2 x+ds/2];
    yy=[y-ds/2 y+ds/2];
    imagesc(xx,yy,pv(kk,13))
    hold on
end
axis([0 10 0 10])
colorbar
caxis(c4)
set(gca,'ydir','normal');
xlabel(['{\bf (h)} $\pi_{12}$'],'FontSize',16,'interpreter','latex')
xticks([1:2:20])
xticklabels({'1','2','3','4','5'})
yticks([1:2:20])
yticklabels({'1','2','3','4','5'})
...
posfig{13}=subplot(3,5,13)
for kk=1:n
    x=Statenum(kk,1)*2-1;
    y=Statenum(kk,2)*2-1;
    xx=[x-ds/2 x+ds/2];
    yy=[y-ds/2 y+ds/2];
    imagesc(xx,yy,pv(kk,14))
    hold on
end
axis([0 10 0 10])
colorbar
caxis(c4)
set(gca,'ydir','normal');
xlabel(['{\bf (i)} $\pi_{13}$'],'FontSize',16,'interpreter','latex')
xticks([1:2:20])
xticklabels({'1','2','3','4','5'})
yticks([1:2:20])
yticklabels({'1','2','3','4','5'})
...
posfig{14}=subplot(3,5,14)
for kk=1:n
    x=Statenum(kk,1)*2-1;
    y=Statenum(kk,2)*2-1;
    xx=[x-ds/2 x+ds/2];
    yy=[y-ds/2 y+ds/2];
    imagesc(xx,yy,pv(kk,15))
    hold on
end
axis([0 10 0 10])
colorbar
caxis(c4)
set(gca,'ydir','normal');
xlabel(['{\bf (j)} $\pi_{14}$'],'FontSize',16,'interpreter','latex')
xticks([1:2:20])
xticklabels({'1','2','3','4','5'})
yticks([1:2:20])
yticklabels({'1','2','3','4','5'})
...
posfig{15}=subplot(3,5,15)
for kk=1:n
    x=Statenum(kk,1)*2-1;
    y=Statenum(kk,2)*2-1;
    xx=[x-ds/2 x+ds/2];
    yy=[y-ds/2 y+ds/2];
    imagesc(xx,yy,pv(kk,16))
    hold on
end
axis([0 10 0 10])
colorbar
caxis(c4)
set(gca,'ydir','normal');
xlabel(['{\bf (k)} $\pi_{15}$'],'FontSize',16,'interpreter','latex')
xticks([1:2:20])
xticklabels({'1','2','3','4','5'})
yticks([1:2:20])
yticklabels({'1','2','3','4','5'})
...
pos15=get(posfig{15}, 'Position');
colormap jet
h=colorbar;

set(h, 'Position', [pos15(1)+pos15(3)+0.01 pos15(2)+0.04 pos15(3)*0.1 pos5(4)+pos5(4)+pos5(4)+0.08])
